...
1. Connectez-vous sur Gitlab avec vos identifiants Unistra : [https://git.unistra.fr](https://git.unistra.fr)
2. Cliquez sur votre icône en haut de la partie gauche de l'écran
...
6. Dans un terminal, affichez votre clé avec la commande suivante :
```bash
...
```
7. Copiez-collez votre clé `ssh-rsa AAAAB3N ... AQ== [nom de la clé]` dans le champ "Key" ("Clé") sur Giltab
8. Supprimez la date d'expiration
9. Cliquez sur le bouton "Add key" ("Ajouter la clé")

C'est terminé : vous recevez dans la foulée un mail vous indiquant qu'une clé ssh a été ajoutée.
